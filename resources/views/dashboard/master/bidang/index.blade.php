		...
		<div class="card">
			<div class="card-header">
				<div class="d-flex align-items-center">
					...
					<a href="{{ route('bidang.create') }}" class="btn btn-primary mg-l-auto"><i class="fas fa-plus"></i></a>
				</div>
			</div>
			<div class="card-body">
					...
					<table class="table border-top-0 table-bordered text-nowrap border-bottom" id="responsive-datatable">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a class="btn btn-primary btn-sm" href="{{ route('bidang.show', $bidang->slug) }}">
									...
									<form action="{{ route('bidang.destroy', $bidang->slug) }}" method="post" class="d-inline">
										@method('delete')
										@csrf
										<button type="button" class="btn btn-danger btn-sm" id='deleteData' data-title="{{ $bidang->nama }}">
