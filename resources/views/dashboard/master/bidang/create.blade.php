	...
	<div class="col-xl-6">
		<div class="card box-shadow-0 ">
			...
			<div class="card-body pt-0">
				<form action="{{ route('bidang.index') }}" method="post">
					@csrf
					...
					<div class="form-group">
						...
						<input name="jenis" value="{{ old('jenis') }}" type="text" class="form-control @error('jenis') is-invalid @enderror" id="jenis" placeholder="Masukan jenis">
						@error('jenis')
						<div class="invalid-feedback">
							{{ $message }}
						</div>
