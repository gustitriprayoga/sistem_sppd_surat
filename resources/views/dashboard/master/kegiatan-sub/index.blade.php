		...
		<div class="card">
			<div class="card-header">
				<div class="d-flex align-items-center">
					...
					<a href="{{ route('kegiatan-sub.create') }}" class="btn btn-primary mg-l-auto"><i class="fas fa-plus"></i></a>
				</div>
			</div>
			<div class="card-body">
							...
							<tr>
								...
								<td class="text-nowrap">
									...
									<form action="{{ route('kegiatan-sub.destroy', $kegiatan_sub->slug) }}" method="post" class="d-inline">
										@method('delete')
										@csrf
										<button type="button" class="btn btn-danger btn-sm" id='deleteData' data-title="{{ $kegiatan_sub->nama }}">
