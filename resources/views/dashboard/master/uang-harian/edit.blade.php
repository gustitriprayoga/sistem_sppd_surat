			...
			<div class="card-body pt-0">
				<form action="{{ route('uang-harian.show', $uang_harian->slug) }}" method="post">
					...
					<div class="form-group">
						...
						<input name="non_asn" value="{{ old('non_asn', $uang_harian->non_asn) }}" type="number" class="form-control @error('non_asn') is-invalid @enderror" id="non_asn" placeholder="Masukan non_asn">
						@error('non_asn')
						<div class="invalid-feedback">
							{{ $message }}
						</div>
