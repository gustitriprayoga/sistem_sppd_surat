	...
	<div class="col-xl-6">
		<div class="card box-shadow-0 ">
			...
			<div class="card-body pt-0">
				<form action="{{ route('lama.index') }}" method="post">
					@csrf
					
					<div class="form-group">
						<label for="lama_hari">Lama Hari</label>
						<input name="lama_hari" value="{{ old('lama_hari') }}" type="number" class="form-control @error('lama_hari') is-invalid @enderror" id="lama_hari" placeholder="Masukan lama_hari">
						@error('lama_hari')
